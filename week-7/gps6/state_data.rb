...
# local_variable
# - Visible inside whatever "container" its defined
# - aka, global in the global scope, method level inside a method.
...
# CONSTANT_VARIABLE
# - ALSO global
# - HOWEVER, once you define a constant, your not allowed to redefine it.

# @instance_variable
# - Visible inside a single instance of a class.
# - Visible to every method inside the class.

# @@class_variable
# - Visible inside ALL instances of the SAME class.