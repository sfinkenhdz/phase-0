...
terah.children.carson = {name:
  "Carson"};
terah.children.carter = {name:
  "Carter"};
  terah.children.colton = {name:
  "Colton"};
...
//The only test I had trouble passing was this one:  "carson should be defined as an object and assigned as a child of Terah". It took me a few tries to get the syntax right, although it seems obvious now. And then, I had a good ten minutes stretch when I was using "Colton" rather than "Carson" for the first child, so it wasn't passing the test.
// How difficult was it to add and delete properties outside of the object itself? Overall, not very difficult
// What did you learn about manipulating objects in this challenge?
//I learned how to add and delete properties, how to add properties to properties, and how to create relationships between objects.
